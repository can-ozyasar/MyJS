...
function removeTodoUI(e) {
    ...
    if (e.target.className==="fa fa-remove") { // eğer tıklanan element fa fa-remove ise bu da çarpı işaretine basmış demek 
        console.log("çarpıya basmıştır"); // konsola yazdırıyoruz
        // todo yu arayüzden siliyoruz
        e.target.parentElement.parentElement.remove(); // li elementini siliyoruz  
        ...
        showAlert("success","todo silindi."); // uyarı veriyoruz
    }
